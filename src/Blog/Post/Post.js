    ...
    return (
        <BlogPage cls={post.cls ? 'Post ' + post.cls : 'Post'} post={post}>
            ...
            <div className='wrapper'>
                ...
                <main id='main-content'>{post.body}</main>
            </div>
        </BlogPage>
    );
}
        ...
        <div className='PostSidebar'>
            <div className='PostSidebar__stickersBox' onClick={handleClick}>
                ...
                {saved && (
                    <button className='saved'>
                        <span aria-hidden='true' className='heart'>
                            &#9825;
                        </span>
            ...
            {relatedPost && (
                <div className='PostSidebar__relatedPost'>
                    <NavLink
                        to={getPostLink(relatedPost)}
                        onClick={handleLinkClick}
                        key={'related.postLink_' + relatedPost.id}
                    >
