        ...
        <LikesProvider value={likes}>
            <div className={'BlogPage notes ' + cls}>
                ...
                <div>
                    ...
                    <div className='BlogPage_body'>{props.children}</div>
                </div>
                <Footer />
            </div>
        </LikesProvider>
...
function AccordionBlog(props) {
    return (
        <div className='BlogPage__accordion_blog'>
            <p className='accordion__blogTag'>
                <b> &#10094; MyNotes &#x2215;&#10095; </b>
            </p>
            <p className='p_larger'>
                Bits and pieces on my journey to become a professional web
                developer.
            </p>
            <p>
                Feel free to comment on my post via{' '}
                <a
...
function AccordionPost(props) {
    ...
    return (
        <div className='BlogPage__accordion_post'>
            <p className='accordion__post_date'>
...
function PostsFeatured() {
    return (
        <span className='PostsFeatured'>
            <a href='#posts-featured' className='icon-heart' aria-hidden='true'>
                &#9734;
            </a>
