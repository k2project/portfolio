...
const game = {
    name:'#game_On',
    desc:(<p>A responsive SPA built with React.js. Online resume based on a vintage game "Break Out". Features:  HTML5 Canvas and SVG with touch responsive controllers / 4 levels with 3 randomly generated layouts each. Give it a go and have a ball!</p>),
    skills:[
...
const rte = {
    ...
    desc:(<p>Responsive SPA built with Meteor.j and React.js. End-to-end commercial (cml.) project for a local theatre. Features: dynamically created routes based on a show's name and a customised contact form. </p>),
    skills:[
...
const grant = {
    ...
    desc:(<p>A responsive SPA built with React.js. This project featurs all businesses of a local entrepreneur. End-to-end commercial (cml.) project delivered with Agile methodology. Features: multiple reusable swipeable carousels and HTML5 Video.</p>),
    skills:[
...
const calvocoressi = {
    ...
    desc:(<p>A responsive SPA built with React.js. and Node.js, hosted on Heroku. End-to-end commercial (cml.) project. Features customised accordion and contact form build with Nodemailer.</p>),
    skills:[
...
const mcBride = {
    ...
    desc:(<p>A responsive SPA built with React.js for an international music director. End-to-end commercial (cml.) project based solely on the client's design. Marc's website features  HTML5 Video with fully customised controllers.</p>),
    skills:[
...
const amb = {
    ...
    desc:(<p>A responsive SPA built with React.js for a Scottish businessman. End-to-end commercial (cml.) project based solely on the client's design.</p>),
    skills:[
        'CSS3', 'HTML5', 'JavaScript', 'React', 'GitHub', 'CSS Grid/Flexbox','Responsive Design',
    ],
    img:'amb_1.png',
...
const spm = {
    name:' SPM Advisors',
    desc:(<p>My first commercial (cml.) end-to-end websites built only with HTML, CSS and jQuery. <br/> <small><i>While the code is far from a presentable example ( more like embarrassing! ), I have decided to feature it along with other projects to show how far I have come as a web developer. </i></small></p>),
    skills:[
